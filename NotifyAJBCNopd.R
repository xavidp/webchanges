# title: "NotifyAJBCNopd" # Ajuntament de Barcelona - Oferta Pública d'OCupació
...
url_base <- "https://seuelectronica.ajuntament.barcelona.cat/ca/convocatoria/tecnica-superior-en-gestio"
url_base <- "https://seuelectronica.ajuntament.barcelona.cat/ca/convocatoria/tecnica-superior-en-organitzacio"
webpage <- list()
